    ...
    <div className="nav row">
      ...
      <div className="row mt-2">
        ...
        <div className="d-flex col-sm-6">
          <Link to="/neatfreak" className="link link-hover marginNav" onClick={closeDropdown}>
            Home
          </Link>
          <Link to="/neatfreak/request" className="link marginNav link-hover" onClick={closeDropdown}>
            Contact
          </Link>
          ...
          <Link to="/neatfreak/subscribe" className="link marginNav link-hover" onClick={closeDropdown}>
            Subscribe
          </Link>
          <Link to="/neatfreak/reviews" className="link marginNav  link-hover" onClick={closeDropdown}>
            Why Hire Us
          </Link>
        </div>
      </div>
